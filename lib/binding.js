...
var memoizedProps = [ "isRoot", "firstChild", "lastChild", "nextSibling", "previousSibling" ];

function Binding() {
	this.children = [];
	this.parent = null;
	this._invalidateProps = util.defineComputedProperties(this, util.pick(this, memoizedProps));
...
util.extend(Binding.prototype, Events, {
	...
	insertBefore: function(child, before) {
		...
		// invalidate static properties
		this._invalidateProps();
		child._invalidateProps();
	...
	firstNode: function() {
		return this.firstChild != null ? this.firstChild.firstNode() : null;
	},
	...
	nextSiblingNode: function() {
		...
		return this.nextSibling != null ? this.nextSibling.firstNode() :
