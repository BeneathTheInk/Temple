...
exports.DOM = Binding.DOM.extend({
	...
	initialize: function(template, options) {
		...
		var childOptions = _.extend({}, options, { bindings: Binding._defaultTextBindings });
		this.children = Binding.create(children, Binding._defaultTextBindings, childOptions);
	},
